...
| S2 (ms) | APD GT (ms) | APD Recovered (ms) | Error (ms) | Error (%) |
| :---: | ---: | ---: | ---: | ---: |
...
<div align="center">
  <img src="parameter_learning/0D_parameter_recovery.gif" alt="0D parameter recovery and APD restitution fitting" width="650">
</div>
